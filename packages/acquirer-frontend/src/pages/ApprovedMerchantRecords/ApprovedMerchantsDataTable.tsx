...
interface ApprovedMerchantsDataTableProps<T> extends TableContainerProps {
  data: T[]
...
const ApprovedMerchantsDataTable = <T,>({
  data,
  columns,
  ...
  rowStyle,
  ...props
}: ApprovedMerchantsDataTableProps<T>) => {
...
export default ApprovedMerchantsDataTable
